...
module.exports = (log, process, semverRegex) => {
    ...
    function checkVersion(version) {
        var semanticVersionError;

        semanticVersionError = new Error("Version number is not a semantic version number");
        ...
        /**
         * This could happen in the case where somebody enters
         * a single number instead of a semantic version number.
         */
